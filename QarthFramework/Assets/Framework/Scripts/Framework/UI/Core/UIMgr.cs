...
namespace Qarth
{
    ...
    public partial class UIMgr : TMonoSingleton<UIMgr>
    {
        ...
        private IPanelEventLogger           m_PanelEventLogger;
        #endregion
        ...
        public IPanelEventLogger panelEventLogger
        {
            get { return m_PanelEventLogger; }
            set { m_PanelEventLogger = value; }
        }
...
#region Public Func
        ...
        public void LogPanelOpen(string panelName, PanelEventLogType eventType)
        {
            if (eventType == PanelEventLogType.None || m_PanelEventLogger == null)
            {
                return;
            }
            m_PanelEventLogger.LogPanelOpen(panelName, eventType);
        }

        public void LogPanelClose(string panelName, PanelEventLogType eventType)
        {
            if (eventType == PanelEventLogType.None || m_PanelEventLogger == null)
            {
                return;
            }
            m_PanelEventLogger.LogPanelClose(panelName, eventType);
        }
